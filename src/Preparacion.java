    ...
    public void run() {
        while (contadorDePedidos < pedidos.getCantPedidos()){
            ...
            synchronized (lockMatriz){
                if (matriz.getMatriz()[randomFila][randomColumna].getEstado() == EstadoCasillero.VACIO){ //si esta OCUPADO itera de vuelta
                    ...
                    matriz.getMatriz()[randomFila][randomColumna].setEstado(EstadoCasillero.OCUPADO); //casillero->OCUPADO
